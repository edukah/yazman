...
class Hyperlink extends Inline {
  constructor (editor, { hyperlink = null, domNode = null } = {}) {
    ...
    if (!hyperlink) {
      throw new Error('Yazman Hyperlink: `hyperlink` (href) parametresi zorunludur.');
    }

    if (Hyperlink.isUnsafeUrl(hyperlink)) {
      hyperlink = '#';
    }
